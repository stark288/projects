...
String apiKey = "aio_TynW952XcWo7IGD1oSI8nvJqi3A6";     //  Enter your Write API key here

const char* server = "api.thingspeak.com";

const char *ssid =  "KIOTWIFI-3";     // Enter your WiFi Name

const char *pass =  "KIOT@Eee321"; // Enter your WiFi Password
